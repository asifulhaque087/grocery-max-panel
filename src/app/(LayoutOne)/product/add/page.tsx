                        ...
                        {attributeValues.map((atv) => (
                          ...
                          >
                            ...
                            <div className="mt-[10px]">
                                ...
                                <div>
                                  ...
                                  <input
                                    onChange={async (
                                      ...
                                      let files = await convertToBase64(
                                        e.target.files
                                      );
                                    ...
                                    id="file-input"
                                    multiple
                                    className="block w-full border border-gray-200 shadow-sm rounded-md text-sm focus:z-10 focus:border-[#7367f0] focus:ring-[#7367f0] dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400
                              ...
                              <div className="flex items-center gap-x-[10px] gap-y-[20px] flex-wrap mt-[30px]">
                                {photos?.map((photo, i) => (
                                  <div
                                    key={i}
